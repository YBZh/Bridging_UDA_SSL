...
class ImageClassifier(nn.Module):
    ...
    def __init__(self, backbone: nn.Module, num_classes: int,
                 bottleneck_dim: Optional[int] = 1024, width: Optional[int] = 1024, max_iters=1000, pre_trained=True):
        super(ImageClassifier, self).__init__()
        self.backbone = backbone
        self.grl_layer = WarmStartGradientReverseLayer(alpha=1.0, lo=0.0, hi=0.1, max_iters=max_iters, auto_step=False)
