...
from data.data_list import Imagelists_VISDA, return_classlist
...
def return_dataset(args, drop_last_flag=True):
    base_path = './data/txt/%s' % args.dataset
    root = args.datapath + '/domain_adaptation/%s/' % args.dataset
    image_set_file_s = \
    ...
    target_loader = \
        torch.utils.data.DataLoader(target_dataset,
                                    ...
                                    num_workers=3,
                                    shuffle=True, drop_last=drop_last_flag)
    target_loader_val = \
